...
func init() {
	problemdaemon.Register("system-stats-monitor", types.ProblemDaemonHandler{
		Factory:              NewSystemStatsMonitorOrDie,
		CmdOptionDescription: "Set to true to enable, or any other value to disable."})
}
